...
export const ES_FRONTEND_DEVELOPER = process.env.NEXT_PUBLIC_ES_FRONTEND_DEVELOPER;
export const EN_FRONTEND_DEVELOPER = process.env.NEXT_PUBLIC_EN_FRONTEND_DEVELOPER;
